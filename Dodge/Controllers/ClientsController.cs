...
namespace Dodge.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,name,identityCard,webPage,address,phone,sectors")] Client client)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var client = await _context.Cliente.SingleOrDefaultAsync(m => m.id == id);
            if (client == null)
            {
                return NotFound();
            }
